...
public class FreemarkerObject {
    ...
    public String getExtendsDeclaration(final POJOClass pojo) {
        ...
        //        if (s.length() < 1) {
        //            s = "extends com.orprovision.spectrum.storage.dao.v1.AbstractEntity";
        //        }
...
//        }
    ...
    public String generateManyToOneAnnotation(final EntityPOJOClass pojo, final Property p, String table) {
        ...
        String s = pojo.generateManyToOneAnnotation(p);
    ...
    public String getJavaTypeName(final EntityPOJOClass pojo, final Property field, final boolean jdk5) {
        String s = pojo.getJavaTypeName(field, jdk5);
    ...
    public String setVariable(final EntityPOJOClass pojo, final Property field, final boolean jdk5) {
    ...
    public String getEntityName(final EntityPOJOClass pojo) {
        String pkg = (pojo.getPackageName().replace("com.orprovision.spectrum.storage.dao.v1", ""));
    ...
    public String getParameters(final Cfg2JavaTool c2j, final EntityPOJOClass pojo, final boolean jdk5, final boolean full) {
        //
        //        final List fullConstructor = pojo.getPropertyClosureForFullConstructor();
        //        final List minimalConstructor = pojo.getPropertyClosureForMinimalConstructor();
        //
    ...
    public String asParameterList(final Cfg2JavaTool c2j, final Iterator fields, final boolean useGenerics, final ImportContext ic) {
        ...
        while (fields.hasNext()) {
            ...
            sb.append("final ");
            sb.append(c2j.getJavaTypeName(field, useGenerics, ic))
              .append(" ")
    ...
    public String annotate(final EntityPOJOClass pojo, final Property p, final RootClass root, final Cfg2HbmTool tool) {
        ...
        if (null != column) {
            ...
            while (it.hasNext()) {
                index = (org.hibernate.mapping.Index) it.next();
